module.exports = (function(){
	...
	var fangutils = require('./fangutils');
	var sys = require('sys');
	...
	dialog.prototype.showLineBoder = function(width) {
		width = width || dialog.DIALOG_WIDTH;
		sys.puts(this.getBoder(width).BORDER_COLOR);
	};
